   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
	...
	function save()
		...
		if (!b) 
			...
			{
			document.addPhoto.action="gallerypkgactions.php?msg=save";
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			   <div class="row"> 
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<?php
								include('conn.php');
								include('zoom.php');
								$result = mysqli_query($conn,"SELECT * FROM tbl_gallery_pkg order by photoid desc") or die('Query Not Executed');
								$i=0;
								...
								while($row = mysqli_fetch_array($result)){
									 echo "<a href='../gallerypkg/" . $row['name'] . "' rel='lightbox1' class='effectable'><img src='../gallerypkg/" . $row['name'] . "' width=50 height=50 title=".$row['title']."/></a>";
								 echo "<a href='gallerypkgactions.php?id=$row[photoid]&msg=delete'><img src=images/cross.png border=0 width=25 height=25></a>";
								}
								echo "</marquee>";
							?>	
						</div>
				...
				<?php
				include('conn.php');
				$fetch_noofphotos="select count(*) mycount from tbl_gallery_pkg";	
