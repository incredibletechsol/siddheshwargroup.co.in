	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				$target_path = "../gallerypkg/";
				$target_path=$target_path.basename($fileName);
				
				if(move_uploaded_file($_FILES['photo']['tmp_name'],$target_path))
					{
					$gallery_insert = "INSERT INTO tbl_gallery_pkg(name,title) values('$fileName','$title')";
		...
		<div id="boxes">
				<div style="top:150px; left: 551.5px; display: none;" id="dialog" class="window">
					...
					<?php
					echo "<a href='gallerypkg.php'><img src='images/cross.png' width='16' style='border:none; cursor:pointer;' /></a>";
					?>
					</div>
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				{
				$id = $_GET['id'];
				$fetch_existing_photo_query="SELECT name FROM tbl_gallery_pkg where photoid='$id'";
				...
				$gallery_delete = "delete from tbl_gallery_pkg where photoid='$id'";
