							...
							echo "<div class='featured-imagebox featured-imagebox-portfolio ttm-box-view-top-image'>";
								echo "<div class='ttm-box-view-content-inner'>";
									echo "<div class='featured-thumbnail'>";
										echo "<a href='#'> <img class='img-fluid myimg' src='gallerypkg/$row[1]' alt='image'></a>";
									echo "</div>";
									echo "<div class='ttm-box-view-overlay'>";
										echo "<div class='featured-iconbox ttm-media-link'>";
											echo "<a class='ttm_prettyphoto ttm_image' title='$row[2]' data-rel='prettyPhoto' href='gallerypkg/$row[1]'><i class='ti ti-search'></i></a>";
										echo "</div>";
									echo "</div>";
								echo "</div>";
